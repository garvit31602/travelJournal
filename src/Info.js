...
function Info(){
    return(
        <div id="Info">
            <img src={require("./images/Rectangle 90.png")}></img>
            <div id="name">Garvit Sharma</div>
            <div id="job">Software Developer</div>
            <div id="website">garvitsharma.website</div>
            <div id="buttons">
            <button id="email">
                <img src={mail}></img>
                Email</button>
            <button id="linkedin">
            <svg xmlns="./images/Linkedin Icon.svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
